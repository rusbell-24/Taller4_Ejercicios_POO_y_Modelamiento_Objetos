...
import edu.sofka.exercise2.Addition;
import edu.sofka.exercise3.SortBy;
import edu.sofka.exercise4.Ferry;
import edu.sofka.exercise4.Vehicle;
import edu.sofka.exercise4.VehicleWarehouse;
import edu.sofka.exercise5.*;
import edu.sofka.exercise6.ReadNumbers;
...
public class Main {
                        ...
                        case 2:
                            ...
                            try {
                                ...
                                System.out.println(
                                        "la gravedad es: " +
                                                newPlanetarySystem.
                                                        calculateGravitationalAttraction(
                                                                idplanet1,
                                                                idplanet2,
                                                                distanciaEntreEllos
                                                        )
                ...
                case 5:
                    ...
                    switch (secondLevelOptions) {
                        case 1:
                            ...
                            for (Bicycle bicycle :
                                    vehicleWarehouse.getStockBicycle()) {
                        ...
                        case 3:
                            System.out.println(
                                    "Ingrese numero de vehiculos a construir: ");
                            numberOfVehicles = userData.nextInt();
                            do {
                                requestVehicleData();
                                requestBoatData();
                        ...
                        case 4:
                            ...
                            for (Motorcycle motorcycle : vehicleWarehouse.
                                    getStockMotorcycle()) {
                                commonImpressionVehicle(motorcycle);
                                System.out.print(
                                        ", Tipo de frenos: " + motorcycle.
                                                getTypeOfBrakes() +
                                                ", Tipo de encendido: " + motorcycle.
                                                getIgnitionType() + "\n"
                                );
                            }
                        ...
                        case 5:
                            ...
                            for (Truck truck : vehicleWarehouse.getStockTruck()) {
                                ...
                                System.out.print(
                                        ", Numero de ejes: " + truck.
                                                getNumberOfAxes() +
                                                ", Tipo de camión: " + truck.
                                                getTypeOfTruck() + "\n"
                                );
                            }
     ...
     * @since 1.0.0
     */
    private static void requestVehicleData() {
